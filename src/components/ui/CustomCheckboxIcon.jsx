...
export function CustomCheckboxIcon(props) {
  ...
  // isChecked === true returns  an icon with empty "d" because icon border is used as an area separator in "ButtonCheckbox"
  return (
    <>
      {isChecked ? (
        ...
        <Icon viewBox="0 0 24 24" {...rest}>
          <path fill="none" stroke="#ff0000" strokeWidth={"1.5"} d={""} />
        </Icon>
      )}
    </>
  );
